...
ActiveRecord::Schema.define(version: 20160621160042) do
  ...
  add_index "subscriptions", ["user_id", "subscriptable_id", "subscriptable_type"], name: "user_and_subscriptable_uniq_index", unique: true, using: :btree
